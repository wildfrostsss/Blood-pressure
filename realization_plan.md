...
## Этап 11: Перестройка навигации на отдельные страницы

- [x] **Задача 11.1:** Создать отдельные HTML-страницы для каждого раздела.
    - Создать measurement.html для страницы добавления измерений.
    - Создать calendar.html для страницы календаря.
    - Создать charts.html для страницы графиков.
    - Обновить index.html для работы с плитками-ссылками.

- [x] **Задача 11.2:** Разделить логику JavaScript по страницам.
    - Создать index.js для главной страницы.
    - Создать measurement.js для страницы измерений.
    - Создать calendar.js для страницы календаря.
    - Создать charts.js для страницы графиков.

- [x] **Задача 11.3:** Обновить Service Worker для работы с несколькими страницами.
    - Изменить sw.js для корректной работы с несколькими страницами.
    - Обновить стратегию кэширования для новой архитектуры.

- [x] **Задача 11.4:** Обновить манифест для работы с несколькими страницами.
    - Изменить manifest.json для корректной работы с несколькими страницами.
    - Добавить favicon.ico.

- [x] **Задача 11.5:** Загрузить новую архитектуру на GitHub.
    - Добавить все новые и измененные файлы в индекс.
    - Создать коммит с описанием изменений.
    - Отправить изменения на удаленный репозиторий GitHub.